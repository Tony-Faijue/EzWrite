<header>
    ...
    <nav class="bg-purple-700 p-4">
        <div class="container mx-auto flex flex-col lg:flex-row justify-between items-center">
            <div class="text-zinc-100 font-bold text-3xl mb-4 lg:mb-0 hover:text-orange-400 hover:cursor-pointer">
                <p>Blog App<i class="fa fa-users ml-2" aria-hidden="true"></i>
                </p>
            </div>
            <div class="lg:hidden">
                <button class="text-zinc-100 focus:outline-none">
            ...
            <div class="lg:flex flex-col lg:flex-row lg:space-x-4 lg:mt-0 mt-4 flex items-center text-xl">
                <a href="{{route('user-home')  }}" class="text-zinc-100 px-4 py-2 hover:text-orange-400">My
                    Dashboard</a>
                <a href="{{route('home')  }}" class="text-zinc-100 px-4 py-2 hover:text-orange-400">Home</a>
                ...
                <form id="logout-form" action="{{route('logout')}}" method="POST">
                    @csrf
                    <button type="submit" class="text-zinc-100 px-4 py-2 hover:text-orange-400">
                        Logout
                    </button>
                </form>
            </div>
