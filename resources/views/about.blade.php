...
@section('content')
    <div class="w-full">
        <div class="border border-red-500 bg-grad-2 p-4 space-y-12">
            <div class="bg-white border border-purple-500 p-4 rounded-2xl space-y-4">
                <div class="border border-amber-400 space-y-8">
                    <h1 class="text-3xl md:text-4xl lg:text-5xl text-center">EzWrite keeps things simplistic
                        so you can focus on what matters, your words. Join us to create, connect and share without
                        distractions. </h1>
                </div>
                <div class="border border-amber-400 space-y-8">
                    <p class="text-base md:text-lg lg:text-xl author-italic text-center">Lorem ipsum, dolor
                        sit amet
            ...
            <div class="border border-green-400 p-4 space-y-8">
                ...
                <div class="container mx-auto">
                    <div class="flex flex-row border border-red-600">
                        <div class="border border-blue-800 grid grid-cols-1 md:grid-cols-2 w-full gap-x-8">
                            <div class="bg-white border border-amber-200 space-y-4">
                                <h1 class="text-center sm:text-2xl md:text-3xl lg:text-4xl">About Us</h1>
                                <p class="text-base md:text-lg lg:text-xl">The goal of EzWrite is to create
                                    an environment
                                    where users can develop their writing
                                    skills when it comes to writing in a blog structured format.
                                </p>
                                <ul class="border border-amber-400 list-disc text-base md:text-lg lg:text-xl ml-8">
                ...
                <div class="container mx-auto">
                    <div class="flex flex-row border border-red-600">
                        <div class="border border-blue-800 grid grid-cols-1 md:grid-cols-2 w-full gap-x-8">
                            ...
                            <div class="bg-white border border-amber-200 space-y-4">
                                <h1 class="text-center sm:text-2xl md:text-3xl lg:text-4xl">About Me</h1>
                                <p class="text-base md:text-lg lg:text-xl">I am the founder of EzWrite .
                                    What began as a
                ...
                <div class="container mx-auto">
                    <div class="flex flex-col border border-red-400 space-y-4">
                        <div class="bg-white border border-purple-400">
                            <div class="text-center">
                                <h1 class="sm:text-2xl md:text-3xl lg:text-4xl">Community</h1>
                            </div>
                            <div class="text-center">
                                <p class="text-base md:text-xl lg:text-2xl">At EzWrite, we are building a
                                    vibrant
                                    ...
                                    blogging journey or you have been writing for years, you will find a welcoming space
                                    full of
                                    encouragement and collaboration. Join EzWrite to sharpen your skills, expand your
                                    knowledge
                                    and
                                    make meaningful contributions in a supportive environment designed to help you succeed.
                                </p>
                            </div>
                        </div>
